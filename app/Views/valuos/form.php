...
<div class="form-card-clean">
    <div class="form-card-header">
        <h3><i class="fas fa-calculator"></i> <?= $valuo ? 'Actualizar Valuación' : 'Datos de la Valuación' ?></h3>
    </div>
    ...
    <form action="<?= $action ?>" method="POST">
        ...
        <div class="form-card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label for="monto_estimado">
                        <i class="fas fa-dollar-sign"></i> Monto Estimado
                    </label>
            ...
            <div class="form-group">
                <label for="porcentaje_de_avance">
                    <i class="fas fa-percentage"></i> Porcentaje de Avance
                </label>
                <div class="input-with-addon">
                    <span class="input-addon">%</span>
            ...
            <div class="form-group">
                ...
                <textarea id="observaciones" name="observaciones" class="form-control" rows="3"
                          placeholder="Observaciones de la valuación..."><?= e($valuo['observaciones'] ?? '') ?></textarea>
            </div>
        </div>
