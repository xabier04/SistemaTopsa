...
<div class="card" style="max-width: 700px;">
    <div class="card-body">
        <form action="<?= $action ?>" method="POST">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="fecha_de_pago"><i class="fas fa-calendar"></i> Fecha de Pago</label>
                    <input type="date" id="fecha_de_pago" name="fecha_de_pago" class="form-control" 
                           value="<?= date('Y-m-d') ?>" required>
                </div>
                <div class="form-group">
                    <label for="monto_abonado"><i class="fas fa-dollar-sign"></i> Monto ($)</label>
            ...
            <div class="form-group">
                <label for="tipo_de_transaccion"><i class="fas fa-tag"></i> Tipo de Transacción</label>
